...
export default function DeviceTransferOTP() {
    ...
    const handleVerifyOTP = async () => {
        ...
        if (!pendingPassword) {
            showToast({
                ...
                message: 'Please go back and try logging in again',
            });
            return;
        }
        ...
        try {
            ...
            showToast({
                ...
                message: 'You are now logged in on this device',
            });

            // Navigation handled by useEffect above
        } catch (err: any) {
            // Error handled by useEffect showing the error toast
            console.error('Device transfer verification error:', err);
        }
    };
    ...
    const handleBack = () => {
        // Clear session conflict state when going back
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.headerContent}>
                    ...
                    <Text type='title' style={styles.appName}>Device Transfer</Text>
                    <Text type='body2' style={styles.tagline}>Verify to login on this device</Text>
                </View>
            </LinearGradient>
                    ...
                    <Animated.View style={[styles.formCard, { opacity: fadeAnim }]}>
                        ...
                        <View style={styles.infoSection}>
                            ...
                            <Text type='body2' style={styles.infoText}>
                                Logging in here will log out your session on{' '}
                                <Text type='bodySemiBold' style={styles.deviceHighlight}>
