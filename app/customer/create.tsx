        ...
        >
            {({
                ...
                <ScrollView className="flex-1 bg-white px-5 py-6">
                    ...
                    {/* Date Picker */}
                    {values.needService === "schedule" && (
                        <View className="mb-5">
                            <SectionTitle title="Preferred Date (Optional)" />
                            <TouchableOpacity
                                onPress={() => setShowDatePicker(true)}
                                className="flex-row items-center border border-blue-400 rounded-lg px-4 py-3"
                            >
                                <CalendarDays size={18} color="#2563EB" />
                                <Text className="ml-2 text-gray-600 text-sm">
                                    {values.selectedDate
                                        ? new Date(values.selectedDate).toDateString()
                            ...
                            {showDatePicker && (
                                <DateTimePicker
                                    ...
                                    onChange={(_, date) => {
                                        ...
                                        setFieldValue("selectedDate", date || null);
                                    }}
                                />
                            )}
                        </View>
                    ...
                    <View className="flex-row justify-between mb-10">
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => router.push("customer/live-offers")}
